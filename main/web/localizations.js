...
const PRINTDECK_EXTRA_TRANSLATIONS={
  ...
  "This version pairs your device only. Printer data and remote controls will be added later.":["Ta wersja umożliwia tylko parowanie urządzenia. Dane drukarek i zdalne sterowanie dodamy później.", "Esta versión solo vincula el dispositivo. Los datos de las impresoras y el control remoto se añadirán más adelante.", "Cette version permet uniquement d’associer l’appareil. Les données des imprimantes et les commandes à distance seront ajoutées ultérieurement.", "Diese Version koppelt nur dein Gerät. Druckerdaten und Fernsteuerung werden später ergänzt.", "此版本仅支持设备配对。打印机数据和远程控制将在后续版本中添加。"],
