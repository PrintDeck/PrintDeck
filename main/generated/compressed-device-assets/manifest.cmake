...
if(NOT resource_hash STREQUAL "fad6cc97e6b10cb64223efe817f2e42692cfbd35916805cff003b1c868d48d79")
    message(FATAL_ERROR "Compressed device asset source is stale; regenerate compressed device assets.")
endif()
...
if(NOT resource_hash STREQUAL "d2a74c41283bcb8428f61ca2d8132aa85d7741b89b3eb576184eaed9448e6d06")
    message(FATAL_ERROR "Compressed device asset output is stale; regenerate compressed device assets.")
endif()
...
if(NOT resource_hash STREQUAL "b4cb5914569bb5696142622e7d692fcc0b4daca7b3cd306bc71f59f1b515badb")
    message(FATAL_ERROR "Compressed device asset output is stale; regenerate compressed device assets.")
endif()
