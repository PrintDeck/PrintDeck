...
if(NOT resource_hash STREQUAL "52dec8910ccb84d7f027c6f162d93fd09cea95a9fb8a2f23db2e63e14a152fb8")
    message(FATAL_ERROR "Compressed device asset source is stale; regenerate compressed device assets.")
endif()
...
if(NOT resource_hash STREQUAL "cc63dd3b3e5d9ba65006096691b2de67d5e2205d51c545634aa63704ae80b672")
    message(FATAL_ERROR "Compressed device asset output is stale; regenerate compressed device assets.")
endif()
...
if(NOT resource_hash STREQUAL "76dc863200bb6a963f4e34beb17a8cca11a24c6cb3b62e3ea33d94a4f0d1f003")
    message(FATAL_ERROR "Compressed device asset output is stale; regenerate compressed device assets.")
endif()
